<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealLinkEditorTest.aspx.cs" Inherits="LinqIt.Libraries.WebTest.Components.RealLinkEditorTest" %>
...
<body>
    ...
    <div>   
        <cc1:LinqItLinkEditor ID="LinqItLinkEditor1" runat="server"></cc1:LinqItLinkEditor>
    </div>
    </form>
</body>
</html>
