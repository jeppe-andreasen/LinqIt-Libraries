<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RealImageEditorTest.aspx.cs" Inherits="LinqIt.Libraries.WebTest.Components.RealImageEditorTest" %>
...
<body>
    ...
    <div>
        ...
        <cc1:LinqItImageEditor ID="LinqItImageEditor1" runat="server">
        </cc1:LinqItImageEditor>
